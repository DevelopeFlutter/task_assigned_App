...
class Admin_chat extends StatefulWidget {
  ...
  const Admin_chat({super.key, required this.chat_room_model});

  @override
  State<Admin_chat> createState() => _Admin_chatState(chat_room_model);
}

class _Admin_chatState extends State<Admin_chat> {
  Chat_room_model chat_room_model;

  _Admin_chatState(this.chat_room_model);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          chat_room_model.user_model.name,
          style: TextStyle(
          ...
          Expanded(
            child: FirebaseAnimatedList(
              ...
              itemBuilder: (context, snapshot, animation, index) {
                ...
                Chat_model model = Chat_model.fromJson(snapshot.value as Map);

                if (model.sender_id == '123') {
                  return Align(
                              ...
                              Visibility(
                                ...
                                child: Padding(
                                  padding: EdgeInsets.only(
                                      ...
                                      top: height * 8 / height),
                                  child: my_txt(
                                      txt: model.msg, txt_color: Colors.white),
                                ),
                              ),
                              Visibility(
              ...
              Visibility(
                ...
                child: Expanded(
                  child: Padding(
                    ...
                    child: my_input_field(label: 'Message', controler: msg),
                  ),
                ),
              ),
              Visibility(
